...
/*   Updated: 2023/12/03 13:51:44 by akisuzuk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	signal_handler(int signum, siginfo_t *info, void *context)
{
	...
	// ★8ビットずつ送ってるのに日本語が表示できてしまう理由は、g_bit_charを上書きじゃなくて連続的に更新してるから
	// 日本語が1バイトx2回で送信されたとしても、1回に2バイト以上で読み込めば日本語として表示されるということか
	// GNLじゃないけど、入力/出力の幅を大きめにとってれば対応できるということね
	c = 0xff & g_char;
	if (i == 8)
	{
